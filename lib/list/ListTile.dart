    ...
    if (leading != null) {
      leadingIcon = IconTheme.merge(
        ...
        child: Row(
          children: <Widget>[
            leading,
            SizedBox(width: title != null ? 15 : 0,)
          ],
        )
      );
    }
    ...
    return InkWell(
      ...
      child: Semantics(
        ...
        child: SafeArea(
          ...
          child: Row(
            children: <Widget>[
              WidgetUtil.createWidget(leadingIcon),
              Expanded(
                child: Container(
...
class _RenderListTile extends RenderBox {
  ...
  void performLayout() {
    ...
    if (!hasSubtitle) {
      ...
      // minVerticalPadding on top and bottom.
      if (titleY < minVerticalPadding ||
          (subtitleY + subtitleSize.height + minVerticalPadding) > tileHeight) {
        tileHeight = titleSize.height + subtitleSize.height + 2.0 * minVerticalPadding;
        titleY = minVerticalPadding;
        subtitleY = titleSize.height + minVerticalPadding;
      }
    }
...
class DividerRenderObject extends RenderBox {
