...
class UnderlineDecoration extends PinDecoration implements SupportGap {
  ...
  void drawPin(
    ...
    var startX = 0.0;
    var startY = mainHeight - strokeWidth;
  ...
  @override
  String toString() {
    return 'UnderlineDecoration{gapSpace: $gapSpace, gapSpaces: $gapSpaces, color: $color, lineHeight: $strokeWidth, enteredColor: $enteredColor}';
  }
}
