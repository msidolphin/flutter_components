...
import 'PercentTabIndicator.dart';

const double _kTabHeight = 46.0;
const double _kTextAndIconTabHeight = 72.0;

/// A material design [GTabBar] tab.
///
...
/// See also:
///
///  * [GTabBar], which displays a row of tabs.
///  * [TabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [GTabBar] and a [TabBarView].
///  * <https://material.io/design/components/tabs.html>
class GTab extends StatelessWidget {
  /// Creates a material design [GTabBar] tab.
  ///
...
class _IndicatorPainter extends CustomPainter {
  _IndicatorPainter({
    ...
    oldValue = controller.animation.value;
    /// TODO 是否有更好的判断方法？
  ...
  Rect _currentRect;
  PercentTabIndicatorPainter _painter;
...
class GTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [GTab] widgets.
  ///
  ...
  /// and the entire [GTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// the indicator with the tab's text for [GTab] widgets and all but the
  /// shortest [GTab.text] values.
  ///
  ...
  final PercentTabIndicator indicator;
  ...
  /// An optional callback that's called when the [GTabBar] is tapped.
  ///
  ...
  /// How the [GTabBar]'s scroll view should respond to user input.
  ///
...
class _GTabBarState extends State<GTabBar> {
  ...
  @override
  void didUpdateWidget(GTabBar oldWidget) {
